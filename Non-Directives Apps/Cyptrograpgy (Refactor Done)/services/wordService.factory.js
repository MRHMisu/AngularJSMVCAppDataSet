...
//servicesModule.factory('WordService',
angular.module('myApp').service('WordService', WordService);
...
function WordService($http) {
    ...
    $http({method: 'GET', url: 'lib/wordList/2of12-unix.txt'}).success(function (data, status, headers, config) {
