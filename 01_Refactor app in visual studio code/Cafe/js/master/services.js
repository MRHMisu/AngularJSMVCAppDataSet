...
angular.service( 'CafeTownsend', function( sessionService, $route, $location, $window, $log )  {
  ...
  var root = this;    // root scope
    ...
    $route.when('/employee',       { template: 'data/partials/employee.view.html',     controller: CafeTownsend.Controllers.EmployeeController } );
    $route.when('/employee/:id',   { template: 'data/partials/employeeEdit.view.html', controller: CafeTownsend.Controllers.EmployeeEditController } );
