...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials) {
    ...
    function completeRequest(callback, status, response, headersString) {
      // URL_MATCH is defined in src/service/location.util
...
angular.element(document).find('head').append('<style type="text/style">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak{display:none;}ng\\:form{display:block;}</style>');